...
line = plot3(ax,0,0,0,'-r','LineWidth',2); % 画四旋翼运动轨迹
...
-sin(theta) sin(phi)*cos(theta) cos(phi)*cos(theta)]; % 旋转矩阵

wHb = [R quadrotor_pos; 0 0 0 1]; % 定义一个增广矩阵

quadrotor_world = wHb * quadrotor_body; % [4x4][4x6]

quadrotor_atti = quadrotor_world(1:3, :); % 得到四旋翼关键坐标点在地球坐标系的位置，用于画四旋翼真实姿态
...
```
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEwMDA0ODE0MjUsOTc0ODQzOTYzLDYwOD
MzMzMzMCwxNTg0MjMzMzAzLC0xMzMwNDg1NTEwLC01MzE5Nzky
MjksMTA0Mzg0MzI0LDEyOTY5NTcxMTAsMTIxMTk3OTAxNywtMT
U4MTUyMTIzOCwtOTkyOTczNjcwLDM1NTAwNTQ1OCwxNDU4NDcz
Mjk4LC0yMzEzMjUzMDUsODY4MzMzMTc5LC05MDk3NjY1MzIsLT
E5NTQ5Mjc2LDEzOTM2NzgwNzQsLTQxODc4OTAwMV19
-->