...
- **输出模块（out.desire）​**
	...
	-   ​**接口形式**：通常为总线信号（Bus Signal）或结构体，供之后飞控系统（如PID控制器）同步读取四自由度期望值。

![三维轨迹生成](/imgs/2025-05-04/n5O7dN3UI0TOlHs7.png "三维轨迹生成")
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTU0NzgyMzc0MSwyNDk1MzI2MzgsNzcxNz
E2Nzc4LDE3MzU5NjMzNDYsMTgzNjY0Nzg3NywtNzk4OTk0OTc2
LC0xODg0NzUzNDM3LC01MDEzNDQ2MTAsMjA1NTE3Njg0XX0=
-->