...
```
flowchart TD
    A[("力F/力矩M（输入）")] -->|驱动| B[动力学方程计算]
    B --> C[[quadrotor2_system]]
    C --> D[("状态变量 state（输出）")]
    D -->|实时反馈| E[PID控制器]
    ...
    classDef process fill:#e1f5fe,stroke:#039be5;  %% 主流程节点
    classDef feedback fill:#fce4ec,stroke:#e91e63; %% 反馈相关元素
    classDef point stroke-width:0;                %% 圆形端点样式
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNjc4NTEwNjY5LC0xNDc4MzMyMTY2LC0xNT
I3NDUwNzA2LDExNTQ2Nzk4MzcsLTQyMzYzNDU1LC00ODE2NDgy
MDddfQ==
-->