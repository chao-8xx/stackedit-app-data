...
rectangle "力F/力矩M（输入）" as A #aliceblue
rectangle "动力学方程计算" as B #aliceblue
database "quadrotor2_system" as C #lightcyan
rectangle "状态变量state（输出）" as D #aliceblue
rectangle "PID控制器" as E #aliceblue
cloud "形成闭环" as F #lavender
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE3ODgwODc3ODgsNjc4NTEwNjY5LC0xND
c4MzMyMTY2LC0xNTI3NDUwNzA2LDExNTQ2Nzk4MzcsLTQyMzYz
NDU1LC00ODE2NDgyMDddfQ==
-->